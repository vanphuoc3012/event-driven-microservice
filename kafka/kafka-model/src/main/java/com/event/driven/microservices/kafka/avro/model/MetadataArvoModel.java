...
public class MetadataArvoModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MetadataArvoModel\",\"namespace\":\"com.event.driven.microservices.kafka.avro.model\",\"fields\":[{\"name\":\"uri\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"requestId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"dt\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"domain\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"stream\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"topic\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"partition\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"offset\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
    private static final long serialVersionUID = -4312764862162507301L;
    private static final SpecificData MODEL$ = new SpecificData();
    private static final BinaryMessageEncoder<MetadataArvoModel> ENCODER =
            new BinaryMessageEncoder<>(MODEL$, SCHEMA$);
    private static final BinaryMessageDecoder<MetadataArvoModel> DECODER =
            new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<MetadataArvoModel>
            WRITER$ = (org.apache.avro.io.DatumWriter<MetadataArvoModel>) MODEL$.createDatumWriter(SCHEMA$);
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<MetadataArvoModel>
            READER$ = (org.apache.avro.io.DatumReader<MetadataArvoModel>) MODEL$.createDatumReader(SCHEMA$);
     ...
     */
    public MetadataArvoModel(java.lang.String uri, java.lang.String requestId, java.lang.String id,
                             java.lang.String dt, java.lang.String domain, java.lang.String stream,
                             java.lang.String topic, java.lang.String partition,
     ...
     */
    public static BinaryMessageEncoder<MetadataArvoModel> getEncoder() {
        return ENCODER;
    }
     ...
     */
    public static BinaryMessageDecoder<MetadataArvoModel> getDecoder() {
        return DECODER;
    }
     ...
     */
    public static BinaryMessageDecoder<MetadataArvoModel> createDecoder(SchemaStore resolver) {
        return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
    }

    /**
     * Deserializes a MetadataArvoModel from a ByteBuffer.
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return a MetadataArvoModel instance decoded from the given buffer
     * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
     */
    public static MetadataArvoModel fromByteBuffer(
            java.nio.ByteBuffer b) throws java.io.IOException {
        return DECODER.decode(b);
    }

    /**
     * Creates a new MetadataArvoModel RecordBuilder.
     * @return A new MetadataArvoModel RecordBuilder
     */
    public static com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder newBuilder() {
        return new com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder();
    }

    /**
     * Creates a new MetadataArvoModel RecordBuilder by copying an existing Builder.
     * @param other The existing builder to copy.
     * @return A new MetadataArvoModel RecordBuilder
     */
    public static com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder newBuilder(
            com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder other) {
        if (other == null) {
            return new com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder();
        } else {
            return new com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder(other);
        }
    }

    /**
     * Creates a new MetadataArvoModel RecordBuilder by copying an existing MetadataArvoModel instance.
     * @param other The existing instance to copy.
     * @return A new MetadataArvoModel RecordBuilder
     */
    public static com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder newBuilder(
            com.event.driven.microservices.kafka.avro.model.MetadataArvoModel other) {
        if (other == null) {
            return new com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder();
        } else {
            return new com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder(other);
    ...
    /**
     * Serializes this MetadataArvoModel to a ByteBuffer.
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                uri = value$ != null ? value$.toString() : null;
                break;
            case 1:
                requestId = value$ != null ? value$.toString() : null;
                break;
            case 2:
                id = value$ != null ? value$.toString() : null;
                break;
            case 3:
                dt = value$ != null ? value$.toString() : null;
                break;
            case 4:
                domain = value$ != null ? value$.toString() : null;
                break;
            case 5:
                stream = value$ != null ? value$.toString() : null;
                break;
            case 6:
                topic = value$ != null ? value$.toString() : null;
                break;
            case 7:
                partition = value$ != null ? value$.toString() : null;
                break;
            case 8:
    ...
    /**
     * RecordBuilder for MetadataArvoModel instances.
     */
    @org.apache.avro.specific.AvroGenerated
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MetadataArvoModel>
            implements org.apache.avro.data.RecordBuilder<MetadataArvoModel> {
        ...
        /**
         * Creates a Builder by copying an existing MetadataArvoModel instance
         * @param other The existing instance to copy.
         */
        private Builder(com.event.driven.microservices.kafka.avro.model.MetadataArvoModel other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.uri)) {
                this.uri = data().deepCopy(fields()[0].schema(), other.uri);
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setUri(
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearUri() {
            uri = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setRequestId(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearRequestId() {
            requestId = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setId(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearId() {
            id = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setDt(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearDt() {
            dt = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setDomain(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearDomain() {
            domain = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setStream(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearStream() {
            stream = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setTopic(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearTopic() {
            topic = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setPartition(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearPartition() {
            partition = null;
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder setOffset(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.event.driven.microservices.kafka.avro.model.MetadataArvoModel.Builder clearOffset() {
            offset = null;
        ...
        @Override
        @SuppressWarnings("unchecked")
        public MetadataArvoModel build() {
            try {
                MetadataArvoModel record = new MetadataArvoModel();
